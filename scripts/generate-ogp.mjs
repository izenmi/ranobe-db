...
const BADGES = [
  { label: "作品", value: counts.works, color: "#8bc4ea" },
  { label: "著者", value: counts.authors, color: "#f68fbe" },
  { label: "イラストレーター", value: counts.illustrators, color: "#8adcae" },
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .glow--1 { width: 520px; height: 520px; top: -180px; right: -140px; background: #7cd0ff; }
...
<body>
  ...
  <div class="badge">ら</div>
  <h1>らのべDB</h1>
  <p class="tagline">日本語ライトノベルを著者・イラストレーター・受賞歴・テーマから探せるデータベース</p>
  <div class="stats">
    ${BADGES.map(
