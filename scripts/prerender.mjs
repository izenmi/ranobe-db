...
// every work/author/illustrator/publisher/theme/award page instead of one empty shell for the
...
const illustrators = readData("illustrators");
...
const routes = [
  ...
  "/illustrators",
  ...illustrators.map((i) => `/illustrators/${i.id}`),
  "/publishers",
