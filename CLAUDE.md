...
15作品(初回)→105作品(2026-07-31)→155作品(2026-08-01、受賞作50作品追加)→205作品(2026-08-01、デスゲームジャンル20作品+幅広いジャンル30作品を追加)→255作品(2026-08-01、幅広いジャンルの人気作50作品をさらに追加)→359作品(2026-08-01、悪役令嬢・追放・なろう系チート無双・学園ラブコメ・ミステリ・SF/ロボット・ホラー/オカルト・和風/中華風ファンタジー・スローライフ・往年の名作の10ジャンル別バッチで104作品を追加)→448作品(2026-08-01、悪役令嬢/追放/TS/現代異能バトル/VRMMO/悪役貴族/モブ村人系/百合/スポーツ/音楽ものの10ジャンル別バッチで89作品を追加。目標100作品に対し、実在確認できないタイトルは無理に埋めない方針を貫いた結果89作品にとどまった)。448作品時点で著者390・イラストレーター368・出版社61・テーマ44・アワード30。新規テーマとして「悪役令嬢」「追放・パーティ解雇」「スローライフ」「性転換」「悪役貴族・悪役令息」を追加。

## 既知の未着手事項

- **新人賞 / それ以外の賞でのフィルター**: 受賞歴を「新人賞(デビュー契機の公募賞)」と「それ以外(このラノすごい!等の人気投票・ランキング)」に区別してフィルターできるようにする。awards.jsonに賞の種別を表すフィールドの追加が必要
- **表紙画像の未解決作品(28作品)**: 「陰陽ノ京」「境界の彼方」「中二病でも恋がしたい！」(以前から未解決)に加え、359作品化時に9作品、448作品化時にさらに16作品が未解決(楽天ブックス・Koboどちらにも書誌なし、または絶版で確認できず)。詳細は`covers-cache.json`でcoverUrlがnullのエントリを参照。他の書誌情報源を個別確認するか、`covers-cache.json`を手動で埋める
